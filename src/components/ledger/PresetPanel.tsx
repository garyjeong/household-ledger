          ...
          {presets.slice(0, 4).map((preset) => (
            ...
            >
              <div className="flex items-center gap-2 min-w-0">
                ...
                {preset.shortcut && (
                  <Badge variant="outline" className="text-xs h-5 w-5 p-0 flex items-center justify-center">
                    {preset.shortcut}
                  </Badge>
                )}
              </div>
                  ...
                  <div className="flex items-center gap-3 flex-1 min-w-0">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1">
                        <h4 className="font-medium text-text-900 truncate">
                          {preset.name}
                        </h4>
                    ...
                    <div className="space-y-1">
                      <div className="relative">
                        <Input
                          ...
                          inputMode="numeric"
                          className="pr-8"
                          value={field.value ? formatAmount(field.value.toString()).replace('원', '') : ''}
                          onChange={(e) => {
