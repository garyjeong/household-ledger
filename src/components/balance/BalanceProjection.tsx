...
import { type BalanceResponse, type MonthlyProjection, type RecurringExpenseItem } from '@/lib/schemas/balance'
    ...
    <Card className={className}>
      ...
      <CardContent className="space-y-6">
        ...
        <div>
          ...
          <div className="space-y-3">
            {projection.months.map((month, index) => {
              const prevBalance = index === 0 ? totalBalance : projection.months[index - 1].projectedBalance
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-red-700 mt-1">
                  현재 고정 지출 패턴이 지속되면 {months}개월 후 잔액이 부족할 수 있습니다. 
                  지출을 조정하거나 수입을 늘리는 것을 고려해보세요.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="flex items-start gap-2 text-xs text-gray-500">
          ...
          <span>
            예상 잔액은 현재 등록된 고정 지출을 기준으로 계산됩니다. 
            실제 지출은 다를 수 있습니다.
          </span>
        </div>
      </CardContent>
